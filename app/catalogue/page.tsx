    ...
    <div className="min-h-screen bg-[#FFF8F4] overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="flex items-center justify-between mb-8">
          ...
          <a href="/catalogue/print" target="_blank" className="flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold bg-white border border-[#E8E3DB] text-[#6B6B6B] hover:border-[#C4602A] hover:text-[#C4602A] transition-colors">
