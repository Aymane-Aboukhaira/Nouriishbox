                ...
                <>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                        ...
                        <div className="space-y-6">
                            ...
                            >
                                ...
                                {!recordingComplete ? (
                                    <button
                                        ...
                                        className={`w-full py-4 rounded-full font-bold flex items-center justify-center gap-3 transition-all ${isRecording
                            ...
                            >
                                <a
                                    href="https://wa.me/212772276015?text=Bonjour Nourishbox, je souhaite configurer mon profil par message vocal."
                                    target="_blank"
