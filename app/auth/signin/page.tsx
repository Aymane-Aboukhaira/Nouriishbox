    ...
    return (
        <div className="min-h-screen grid lg:grid-cols-2 overflow-hidden bg-background">
            ...
            <div className="flex flex-col justify-center px-8 sm:px-12 md:px-16 lg:px-24 py-16 min-h-screen">
                ...
                >
                    <div className="mb-10">
                        <h2 className="font-serif text-4xl text-text-primary mb-3">Welcome Back</h2>
                        <p className="text-text-muted font-sans text-base">Sign in to your Nourishbox account.</p>
                    </div>

                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        <div className="space-y-2">
                            <label className="block text-sm font-bold text-text-primary px-1">Email address</label>
                            <Input
                                {...register("email")}
                                autoFocus
                                type="email"
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between px-1">
                                ...
                                <a href="#" className="text-xs text-text-muted hover:text-accent transition-colors font-medium">Forgot?</a>
                            </div>
                        ...
                        {authError && (
                            ...
                            >
                                ...
                                <span>{authError} <Link href="/auth/signup" className="underline font-bold">Sign up instead?</Link></span>
                            </motion.div>
                        )}
                    ...
                    <div className="my-10 flex items-center gap-6">
                        ...
                        <span className="text-[10px] font-bold text-text-muted uppercase tracking-[0.2em] whitespace-nowrap">Or continue with</span>
                        <div className="flex-1 h-[1px] bg-border" />
                    </div>
                    ...
                    <p className="text-center text-sm font-medium text-text-muted mt-10">
                        ...
                        <Link href="/auth/signup" className="text-accent underline underline-offset-4 hover:opacity-80 transition-opacity font-bold">Create Account</Link>
                    </p>
                </motion.div>
            </div>
        </div>
